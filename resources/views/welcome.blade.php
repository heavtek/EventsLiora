...
<!-- Mirrored from wpocean.com/html/tf/loveme/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:22:26 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <section class="wpo-hero-slider wpo-hero-style-3">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/nikah2.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/engagement4.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/graduation2.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/nikah3.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/engagement3.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/bride8.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/baptism2.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/baby1.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/decore1.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/shawor3.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/wedding6.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/decore1.jpg">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/bride1.jpg">
                        </div> <!-- end slide-inner --> 
                    </div> <!-- end swiper-slide -->
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="wpo-testimonials-img img-bride">
                            ...
                            <div class="wpo-testimonials-wrap">
                                ...
                                <div class="wpo-testimonials-active owl-carousel">
                                    <div class="wpo-testimonials-item">
                                        <p>This is not only an event planning agency but also a dreamy friend.
                                    ...
                                    <div class="wpo-testimonials-item">
                                        <p>This is not only a event planning agency but also a dreamy friend.
                                            I am very glad to work with them.They make my dream come true. In my wedding
                                            I found them as my best friends. </p>
                                        <div class="wpo-testimonial-info">
                                            <div class="wpo-testimonial-info-img">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-lg-4 col-md-6 col-12">
                                <div class="wpo-pricing-item">
                                    <div class="wpo-pricing-top">
                                        <div class="wpo-pricing-img">
                                            <img src="assets/images/pricing/hii.jpg" alt="">
                                        </div>
                                        <div class="wpo-pricing-text">
                            ...
                            <div class="col col-lg-4 col-md-6 col-12">
                                <div class="wpo-pricing-item">
                                    <div class="wpo-pricing-top">
                                        <div class="wpo-pricing-img">
                                            <img src="assets/images/pricing/8.jpg" alt="">
                                        </div>
                                        <div class="wpo-pricing-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-xl-3  col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget link-widget">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/gallary">Portfolio</a></li>
                            ...
                            <div class="widget wpo-service-link-widget">
                                ...
                                <div class="contact-ft">
                                    ...
                                    <ul>
                                        <li><i class="fi flaticon-email"></i>Liora@gmail.com</li>
                                        <li><i class="fi flaticon-phone-call"></i>+251 912319030</li>
                                        <li><i class="fi flaticon-maps-and-flags"></i>Addis Ababa – Bole
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col col-xl-3  col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget instagram">
                                ...
                                <ul class="d-flex">
                                    <li><a href="portfolio-single.html"><img src="assets/images/instragram/geat3.png"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.html"><img src="assets/images/instragram/8.jpg"
                                                alt=""></a></li>
                                    ...
                                    <li><a href="portfolio-single.html"><img src="assets/images/instragram/5.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.html"><img src="assets/images/instragram/baptism2.jpg"
                                                alt=""></a></li>
...
<!-- Mirrored from wpocean.com/html/tf/loveme/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:22:28 GMT -->
</html>