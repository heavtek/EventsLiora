...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="index-2.html"><img src="assets/images/section-title.png"
                                            alt="Liora Events & Weeding">Liora Events & wedding</a></a>
                                </div>
                            </div>
        ...
        <section class="wpo-service-section pb-0">
            ...
            <div class="container">
                <div class="wpo-service-active owl-carousel">
                    ...
                    <div class="wpo-service-item">
                        <div class="wpo-service-img">
                            <img src="assets/images/service/makeup2.png" alt="">

                            <div class="wpo-service-text">
                                <div class="s-icon">
                                    <i class="fi flaticon-edit"></i>
                                </div>
                                <a href="service-single.html">Makeup</a>
                            </div>
                        </div>
                    </div>
                    <div class="wpo-service-item">
                    ...
                    <div class="wpo-service-item">
                        <div class="wpo-service-img">
                            ...
                            <div class="wpo-service-text">
                                ...
                                <a href="service-single.html">maniqure&pediqure</a>
                            </div>
                        </div>
                    </div>
                </div>
