...
<!-- Mirrored from wpocean.com/html/tf/loveme/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:23:02 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                ...
                                <a class="navbar-brand menu-item-has-children" href="/"><img src="assets/images/section-title.png"
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <ul>
                                        <li>Stylish full makup</li>
                                        <li>Manicure & Pedicure</li>
                                        <li>Photography</li>

                                        <li> <a class="popup-gmaps" href="/contact-wedding">Choose Package</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-engagement">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    <h2>Bridal Shower</h2>
                                    <ul>
                                    <li>Stylish full makeup</li>
                                        <li>Manicure & Pedicure</li>
                                        <li>Photography</li>

                                        <li> <a class="popup-gmaps" href="/contact-bridal">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-baby">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-birthday">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-graduation">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-nikah">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-baptisim">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
                            ...
                            <div class="wpo-event-item">
                                <div class="wpo-event-text">
                                    ...
                                    <li>Stylish full makup</li>
                                        ...
                                        <li> <a class="popup-gmaps" href="/contact-geat">Choose Package</a></li>
                                    </ul>
                                </div>
                                <div class="event-shape-1">
                                    <img src="assets/images/event-shape-1.png" alt="">
